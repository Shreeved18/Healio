    ...
    <div className="flex flex-col item-center text-center gap-4 py-16 text-gray-800" id='speciality'>
        ...
        <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-scroll'>
          {specialityData.map((item, index) => (
            <div onClick={() => {navigate(`/doctors/${item.speciality}`);scrollTo(0,0)}} className='flex flex-col items-center text-xs cursor-pointer shrink-0 hover:scale-105 transition-all duration-300'>
