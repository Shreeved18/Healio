...
const Appointment = () => {
    ...
    const { currency, backendUrl, token, fetchDoctor } = React.useContext(AppContext)
    ...
    return (
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-4 font-medium'>
                ...
                <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6 disabled:bg-gray-400' disabled={!slotTime}>
                    Book Appointment
                </button>
            </div>
